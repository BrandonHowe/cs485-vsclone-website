        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <FooterLink href="https://github.com/BrandonHowe/cs485-llm-ide/releases/latest/download/VSCode-darwin-arm64-latest.zip">Download for macOS</FooterLink>
              <FooterLink href="https://github.com/BrandonHowe/cs485-llm-ide/releases/latest/download/VSCodeUserSetup-x64-latest.exe">Download for Windows</FooterLink>
